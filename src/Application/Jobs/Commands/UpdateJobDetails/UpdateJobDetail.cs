...
using eRecruitment.Domain.Enums;

namespace eRecruitment.Application.Jobs.Commands.UpdateJobDetail;
public record UpdateJobDetailCommand : IRequest
{
...
public class UpdateJobDetailCommandHandler : IRequestHandler<UpdateJobDetailCommand>
{
    private readonly IApplicationDbContext _context;

    public UpdateJobDetailCommandHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task Handle(UpdateJobDetailCommand request, CancellationToken cancellationToken)
    {
